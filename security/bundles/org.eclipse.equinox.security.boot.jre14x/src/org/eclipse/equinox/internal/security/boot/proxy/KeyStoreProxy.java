...
public class KeyStoreProxy extends KeyStoreSpi {
	...
	public void engineLoad( InputStream inputStream, char[] password)
		...
		try {
			...
			Method method = clazz.getDeclaredMethod( "engineLoad", new Class[] {InputStream.class,char[].class});
	...
	public void engineStore( OutputStream outputStream, char[] password)
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineStore", new Class[] {OutputStream.class,char[].class});
			method.setAccessible( true);
	...
	public int engineSize( ) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineSize", new Class[] {});
			method.setAccessible( true);
	...
	public Enumeration engineAliases( ) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineAliases", new Class[] {});
			method.setAccessible( true);
	...
	public boolean engineContainsAlias( String alias) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineContainsAlias", new Class[] {String.class});
			method.setAccessible( true);
	...
	public boolean engineIsKeyEntry( String alias) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineIsKeyEntry", new Class[] {String.class});
			method.setAccessible( true);
	...
	public boolean engineIsCertificateEntry( String alias) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineIsCertificateEntry", new Class[] {String.class});
			method.setAccessible( true);
	...
	public Key engineGetKey( String alias, char[] password)
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineGetKey", new Class[] {String.class,char[].class});
			method.setAccessible( true);
	...
	public void engineSetKeyEntry( String alias, Key key, char[] password, Certificate[] chain)
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineSetKeyEntry", new Class[] {String.class,Key.class,char[].class,Certificate[].class});
			method.setAccessible( true);
	...
	public void engineSetKeyEntry( String alias, byte[] key, Certificate[] chain)
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineSetKeyEntry", new Class[] {String.class,byte[].class,Certificate[].class});
			method.setAccessible( true);
	...
	public String engineGetCertificateAlias( Certificate cert) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineGetCertificateAlias", new Class[] {Certificate.class});
			method.setAccessible( true);
	...
	public Certificate engineGetCertificate( String alias) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineGetCertificate", new Class[] {String.class});
			method.setAccessible( true);
	...
	public Certificate[] engineGetCertificateChain( String alias) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineGetCertificateChain", new Class[] {String.class});
			method.setAccessible( true);
	...
	public Date engineGetCreationDate( String alias) {
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineGetCreationDate", new Class[] {String.class});
			method.setAccessible( true);
	...
	public void engineSetCertificateEntry( String alias, Certificate cert)
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineSetCertificateEntry", new Class[] {String.class,Certificate.class});
			method.setAccessible( true);
	...
	public void engineDeleteEntry( String alias)
		...
		try {
			Class clazz = targetKeyStoreSpi.getClass( );
			Method method = clazz.getDeclaredMethod( "engineDeleteEntry", new Class[] {String.class});
			method.setAccessible( true);
