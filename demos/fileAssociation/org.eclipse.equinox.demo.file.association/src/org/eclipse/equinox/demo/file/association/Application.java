...
public class Application implements IApplication {
	...
	public Object start(IApplicationContext context) {
		// must create and OpenDocument listener and add it before starting the event loop
		// This is necessary to ensure the listener is in place before the first SWT event is fired
